...
class Room:
    ...
    def get_room_in_direction(self, direction):
        # returns an instance of  Room and the direction that room is in
        if direction == "n":
            return {'direction': direction, 'neighbor': self.n_to}
        elif direction == "s":
            return {'direction': direction, 'neighbor': self.s_to}
        elif direction == "e":
            return {'direction': direction, 'neighbor': self.e_to}
        elif direction == "w":
            return {'direction': direction, 'neighbor': self.w_to}
